...
import gera from "../public/shoe-images/gear.png"
    ...
    return (
        <div className="flex flex-col justify-center px-4 sm:px-8 lg:px-16">
            ...
            <div className="ml-4 md:ml-6 mb-6">
                <p className="text-[20px] md:text-[23px] font-medium">Don&apos;t Miss</p>
            </div>
            ...
            {/* Text Section */}
            <div className="text-center flex flex-col mt-8 md:mt-12 lg:mt-16 justify-center leading-[30px] md:leading-[50px] lg:leading-[70px] px-4">
