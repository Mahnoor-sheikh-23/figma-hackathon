    ...
    return (
        <div className='flex  items-center flex-col'>
            <div className='flex md:flex-row flex-col w-full justify-between md:gap-96 items-center'>
                ...
                <div className='flex gap-9 mr-14'>
                    <p>00 800 100 9538</p>
                    <Image src={msg} alt="Bag Icon" className=" object-cover" />
                    <Image src={bag} alt="Bag Icon" className="object-cover" />
                </div>
            </div>
            <div className='flex md:flex-row flex-row md:gap-20 md:w-[880px] md:h-[2176px] '>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div>
                            ...
                            <div className='space-y-6'>
                                ...
                                <button className='md:w-full w-auto bg-gray-200 text-black  py-3 text-base font-bold  rounded-3xl transition duration-300'>Continue</button>
                            </div>
